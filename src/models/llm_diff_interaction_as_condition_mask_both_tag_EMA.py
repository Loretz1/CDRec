...
class LLM_Diff_interaction_as_condition_mask_both_tag_EMA(GeneralRecommender):
    def __init__(self, config, dataloader):
        super(LLM_Diff_interaction_as_condition_mask_both_tag_EMA, self).__init__(config, dataloader)
