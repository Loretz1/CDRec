...
class UniCDR_without_interaction_and_domain_masking(GeneralRecommender):
    def __init__(self, config, dataloader):
        super(UniCDR_without_interaction_and_domain_masking, self).__init__(config, dataloader)
